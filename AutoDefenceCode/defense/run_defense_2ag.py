...
detector = AutoGenDetectorV1(config_list=config_list)
detector.strategy_name = "explicit_2_agent"  # Use a valid strategy name from defense_prompts.json
...
if __name__ == "__main__":
    ...
    output_dir = "defense_output/gpt3.5-turbo/2Agent"
